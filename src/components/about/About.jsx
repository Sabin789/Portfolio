      ...
      <h2 className='text-light'>Technologies experience and Education</h2>
        ...
        <div className="container about__container">
          <div className="about__content">
            <p>
          I am a 22 years old full-stack web developer. I have started coding
          doing the free online courses from freecodecamp and thenn enrolled in the 
          ...
          aspects and fronend and backend of web development.
            </p>
